...
import no.nav.familie.prosessering.domene.jdbc.TaskRepositoryProxyJdbc
...
internal class TaskControllerTest {
    ...
    private val taskRepositoryJdbc: TaskRepositoryProxyJdbc = mockk()
    ...
    @Before
    fun setup() {
        restTaskService = RestTaskService(taskRepositoryJdbc)
    ...
    fun `skal hente task basert på alle statuser`() {
        ...
        every { taskRepositoryJdbc.finnTasksMedStatus(capture(statusSlot), any()) } returns emptyList()
